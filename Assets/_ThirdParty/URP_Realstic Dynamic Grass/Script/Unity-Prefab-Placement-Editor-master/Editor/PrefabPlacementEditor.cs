...
public class PrefabPlacementEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Slider(Min_size, 0.1f, 10, new GUIContent ("Min_Size"));
        EditorGUILayout.Slider(Max_size, 0.1f, 10, new GUIContent("Max_Size"));
    ...
    public void PrefabInstantiate (int index)
    {
        ...
        {
            float _RandomValue = Random.Range(Min_size.floatValue, Max_size.floatValue);
            instanceOf.transform.localScale = new Vector3(_RandomValue, _RandomValue, _RandomValue);
        }

        GameObject Temp =  GameObject.Find(ParentObjName.stringValue);
        instanceOf.transform.parent = Temp.transform;
